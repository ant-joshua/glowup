...
export default function CreatorRoutineEditorPage() {
  return (
    <PageShell
      title="Creator · Routine Editor"
      description="Shell halaman untuk editor routine (akan dihubungkan ke mock API pada task berikutnya)."
    >
      ...
      <div className="rounded-xl border border-zinc-200 bg-white p-4 text-sm text-zinc-600 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-400">
        Editor routine akan ditambahkan setelah mock API PRD-002 tersedia.
      </div>
    </PageShell>
  );
}
