...
export default function IntelligenceRecommendationsPage() {
  return (
    <PageShell
      ...
      description="Shell halaman untuk recommendations (akan dihubungkan ke mock API pada task berikutnya)."
    >
      <SectionCrumb
        href="/intelligence"
      ...
      <div className="rounded-xl border border-zinc-200 bg-white p-4 text-sm text-zinc-600 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-400">
        Rekomendasi akan ditambahkan setelah mock API PRD-005 tersedia.
      </div>
    </PageShell>
  );
}
